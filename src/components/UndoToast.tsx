...
export default function UndoToast({ visible, onUndo }: Props) {
  ...
  return (
    <div className="fixed bottom-5 left-1/2 z-[60] flex -translate-x-1/2 items-center gap-3 rounded-2xl bg-stone-800 px-4 py-3 text-sm text-white shadow-xl dark:bg-stone-700">
